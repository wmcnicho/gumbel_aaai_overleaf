...
% Single-column figure with the wide combined image = most compact layout:
% it displaces only one column of text and saves a full page vs. a two-column
% figure*. If the panels read too small, switch back to \begin{figure*}[t] with
% \includegraphics[width=0.8\textwidth]{...} (costs ~1 page).
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{tradeoff_curves_combined.png}
