...
\end{quote}
\end{examplebox}
\captionof{figure}{Example of a counterfactual rewrite where Gumbel Machine (GM) retains the student's original wording and paragraph structure almost entirely, appending only a small number of sentences to improve the response. Minimal Edit (ME) instead reorganizes the content by foregrounding a general definition, reordering topics, and introducing new framing devices not present in the student writing.}
\label{ex:ecological-pyramids}